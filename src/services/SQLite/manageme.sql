...
CREATE TABLE Dias_Mes(
    ...
    diaSemana INT NOT NULL -- Podemos guardar o diaSemana como INT provisoriamente, quando insermos os dados na tabela usaremos o DAYOFWEEK()
)
